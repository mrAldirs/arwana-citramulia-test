{!! Form::open([
    'route' => ['transaction.update', [$data->id]],
    'class' => 'form',
    'method' => 'PUT',
    'files' => true,
]) !!}
...
<div class="card-body">
    <div class="form-group">
        ...
        {!! Form::select('product_id', $product->toArray(), $data->product_id, [
            'class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::text('customer', $data->customer, ['class' => 'form-control', 'placeholder' => 'Input Customer']) !!}
    </div>
    @error('customer')
        <div class="alert alert-danger mt-2">
            {{ $message }}
    ...
    <div class="form-group">
        ...
        {!! Form::number('quantity', $data->quantity, ['class' => 'form-control', 'placeholder' => 'Input Quantity']) !!}
    </div>
    @error('quantity')
        <div class="alert alert-danger mt-2">
            {{ $message }}
